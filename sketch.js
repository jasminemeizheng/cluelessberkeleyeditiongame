...
function preload() {
    ...
    campanile = loadImage('assets/campanile.png')
...
function setup(){
  ...
  function draw(){
    ...
    if(campanileChosen){
        image(campanile, 0, 0, 600, 600)
        image(outfits[currentOutfit], 65, 85, 475, 475)
